...
public class Oneal extends Mob {
    ...
    protected void superCalculateMove(Bomber bomberman, Oneal oneal) {
        int xa = 0;
        int ya = 0;
    ...
    protected boolean OnealcanMove() {
        if (direction == 3) return !mobcheckBlock((int)(getX()+0.7), (int)(getY()+0.15)) && !mobcheckBlock((int)getX(), (int)(getY()+0.15));
        if (direction == 2) return !mobcheckBlock((int)(getX()+0.7), (int)(getY()+1)) && !mobcheckBlock((int)(getX()), (int)(getY()+1));
    ...
    public void update() {
        if(!die) {
            animate();
            superCalculateMove(BombermanGame.bomberman, this);
            IsDeath();
        } else {
